...
s.append(PageBreak())
s.append(tab([["constant bound on dv", "median RT, gains 0.8 / 1.0 / 1.2 (ms)", "omissions by 750 ms", "exact-simulator g at gain 1.2 (per s)", "fit loss"],
              ["1.5", "145 / 99 / 76", "3.4 / 0.3 / 0.0 %", "+9.3", "0.14"], ["2.0", "203 / 136 / 102", "13 / 1.7 / 0.2 %", "+8.6", "0.62"],
              ["2.5", "255 / 171 / 127", "31 / 10 / 5.6 %", "+5.2", "2.2"], ["2.94", "321 / 229 / 166", "67 / 30 / 14 %", "+0.5", "10.3"]],
             [1.3*inch, 1.7*inch, 1.3*inch, 1.6*inch, 0.7*inch],
             "Table 2. Why: the networks never produce RTs (readout at 750 ms); each RT is our threshold on dv, which has fast readout fluctuations on top of the slow choice mode. A low threshold is crossed by the fast component and the OU's one leak fits its decay; a high threshold loses most low-gain trials and a one-timescale OU stops fitting. The fitted leak follows the threshold, not the network."))
